...
// $nossl = $posted_settings['nossl'];
	...
	public function get_configuration_template() {
		...
		<tr class="<?php echo $classes; ?>">
			...
			<td>
				<p>{{#if is_already_authenticated}}<?php echo __("<strong>(You appear to be already authenticated,</strong> though you can authenticate again to refresh your access if you've had a problem).", 'updraftplus'); ?>{{/if}}
