...
// $dumped = file_get_contents($updraft_dir.'/'.$tmp_file, false, null, 0, 4096);
	 ...
	 */
	public function email_options_filter($options) {
		return $this->just_one_email($options);
	}
	 ...
	 */
	public function onedrive_options_filter($onedrive) {
	 ...
	 */
	public function azure_options_filter($azure) {
		// Get the current options (and possibly update them to the new format)
	 ...
	 */
	public function googledrive_options_filter($google) {
	 ...
	 */
	public function googlecloud_options_filter($google) {
	 ...
	 */
	public function ftp_options_filter($settings) {
	 ...
	 */
	public function backblaze_options_filter($settings) {
		if (is_array($settings) && !empty($settings['version']) && !empty($settings['settings'])) {
			foreach ($settings['settings'] as $instance_id => $instance_settings) {
	 ...
	 * @return Array filtered settings
	 */
	public function s3_options_filter($settings) {
		if (is_array($settings) && !empty($settings['version']) && !empty($settings['settings'])) {
			foreach ($settings['settings'] as $instance_id => $instance_settings) {
	 ...
	 */
	public function dropbox_options_filter($dropbox) {
	 ...
	 */
	public function webdav_options_filter($webdav) {
		// Get the current options (and possibly update them to the new format)
