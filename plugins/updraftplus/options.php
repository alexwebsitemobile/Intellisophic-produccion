...
class UpdraftPlus_Options {
	...
	public static function admin_init() {
		...
		foreach ($services_to_register as $service) {
			// Possibly registering this would be harmless, but it hasn't been researched yet
			if ('updraftvault' == $service) continue;
			if (is_callable(array($updraftplus, $service.'_options_filter'))) {
				register_setting('updraft-options-group', 'updraft_'.$service, array($updraftplus, $service.'_options_filter'));
			} else {
